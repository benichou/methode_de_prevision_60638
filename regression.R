...
#      xlab = 'P�riode' ,
#      ylab = 'R�sidu normalis�',
#      main = 'R�sidu normalis� en fonction du temps du model_t')
# 
# #Normal ?
...
#          main = 'Boxplot des r�sidus normalis� du mod�le t par semestre' ,
#          xlab = 'Semestre' ,
#          ylab = 'R�sidus par semestre')
# 
# plot(yt ,
#      ylab = 'Somme de la Demande journali�re (MW))',
#      main = '�volution de la demande journali�re � travers le temps')
# 
